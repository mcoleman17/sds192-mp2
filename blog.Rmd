...
Political_graphs
```
The graphic above shows the total contributions to candidates in the house elections, depending on party affiliation. In the State of Illinois, there were 1452 more committees contributing money to republican candidates then Democratic candidates, and the republicans had a higher total number of contributions than Democrats. Prior to this election, the Republicans held 11 seats in Illinois, and the Democrats held eight; However, in this election the Republicans lost five seats, and the Democrats gained four seats. This shows that even though Republicans had more money from which to draw from for the campaign, the turnout of constituents still matters. Meanwhile in both Massachusetts and Maine, Democrats held all of the house seats prior the election, and maintained control in all seats.
...
The data that we used to come up with first graphic tells us interestingly that even though the Republicans candidates in the states of Massachusetts and Maine had less committees to donate to them, they on average contributed more money than Democrat committees; meanwhile, in the state of Illinois, the Democratic Committees contributed more on average than Republicans.
...
When we did our peer presentation, one piece of feedback that we received is that we didn't filter by any of the transaction types in our main graph. At that time we told our peers if we filtered by certain transaction types, then we would get no results for the state of Maine, due to the fact that no contributions were classified under this transaction type. As such we decided to include the above bar graph, which classifies the contributions to the candidates based on their transaction type. This graph shows that in the State of Maine, contributions were only classified under two different transaction types. The most interesting contributions come from the state of Illinois, where the majority of contributions for both parties were designated towards opposing a candidates election. 
